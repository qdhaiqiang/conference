...
import com.centling.conference.schedule.DAO.MeetingScheduleDAO;
...
public class MeetingScheduleService {
	@Resource
	private MeetingScheduleDAO meetingConfScheduleDAO;
	
	public static final String LOCATION_UNDIFIED="未分配会场";
     ...
     * @return
     */
	public List<MeetingLocationModel> findScheduleByMeetingId(String meetingId,Locale local) {
		List<MeetingLocationModel> locaList = new ArrayList<MeetingLocationModel>();
		List list = meetingConfScheduleDAO.findMeetingSchedual(meetingId);
