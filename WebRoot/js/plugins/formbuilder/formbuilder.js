...
(function() {
  ...
  BuilderView = (function(_super) {
    ...
    BuilderView.prototype.saveForm = function(e) {
      ...
      var data = "userType="+Formbuilder.options.data+"&payload="+payload;
      
      if (Formbuilder.options.HTTP_ENDPOINT) {
       // this.doAjaxSave(data);
      }
      return this.formBuilder.trigger('save', data, this.collection.toJSON());
    };
  ...
  Formbuilder = (function() {
    Formbuilder.helpers = {
      defaultFieldAttrs: function(field_type) {
        var attrs, _base;
        attrs = {};
        attrs[Formbuilder.options.mappings.LABEL] = '请定义输入框的标签';
    ...
    Formbuilder.options = {
      ...
      dict: {
        ALL_CHANGES_SAVED: '无更新',
        SAVE_FORM: '保存',
        UNSAVED_CHANGES: '您有尚未保存的操作，如果离开页面，你所做的操作将会丢失。'
      }
    };
    ...
    Formbuilder.options.HTTP_ENDPOINT = opts.urlPath;
    Formbuilder.options.HTTP_METHOD = opts.method;
    Formbuilder.options.data = opts.data;
...
(function() {
	//将website填写网址的编辑栏改成上传文件的编辑栏
	Formbuilder.registerField('address', {
  order: 35,
  view: "<input type='file' />",
  edit: "",
  addButton: "<span class=\"symbol\"><span class=\"fa fa-link\"></span></span> 文件"
});
