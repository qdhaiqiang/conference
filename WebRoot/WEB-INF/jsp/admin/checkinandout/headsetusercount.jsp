...
<script type="text/javascript">
  ...
  <div  id="cc" class ="easyui-layout" data-options="region:'center',border:false,fit:true">
    ...
    <table id="dg" title="未还耳机人员统计" style="width:100%;height:100%"
			data-options="striped:true,rownumbers:true,singleSelect:true,url:'hasheadsetuser/r',method:'post', 
       				 multiSort:true,fit:true,nowrap:false,toolbar:'#toolbar',pagination:'true'">
		<thead>
			<tr>
			    <th data-options="field:'ck',checkbox:true"></th>
				<th data-options="field: 'cname', width:'90',">中文姓名</th>
				<th data-options="field: 'ename', width:'90', ">英文姓名</th>
				<th data-options="field: 'email', width:'90', ">邮箱</th>
